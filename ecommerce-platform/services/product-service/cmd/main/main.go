...
import (
	...
	"github.com/yourname/ecommerce/product-service/internal/database"
	"github.com/yourname/ecommerce/product-service/internal/handler"
	"github.com/yourname/ecommerce/product-service/internal/repository"
...
func main() {
	...
	productCache, err := cache.NewProductCache(redisURL, logger)
	if err != nil { logger.Warn("redis unavailable, running without cache", zap.Error(err)) }
