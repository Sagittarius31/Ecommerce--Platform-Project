...
func NewPaymentHandler(svc *service.PaymentService, webhookSecret string, logger *zap.Logger) *PaymentHandler {
	return &PaymentHandler{svc: svc, webhookSecret: webhookSecret, logger: logger}
}
...
func (h *PaymentHandler) CreatePaymentIntent(c *gin.Context) {
	...
	p, intent, err := h.svc.CreatePaymentIntent(c.Request.Context(), in)
