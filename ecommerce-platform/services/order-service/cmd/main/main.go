...
import (
	...
	"github.com/yourname/ecommerce/order-service/internal/database"
	"github.com/yourname/ecommerce/order-service/internal/handler"
	"github.com/yourname/ecommerce/order-service/internal/messaging"
	"github.com/yourname/ecommerce/order-service/internal/repository"
...
func main() {
	...
	if err != nil { logger.Fatal("rabbitmq failed", zap.Error(err)) }
	defer publisher.Close()

	repo := repository.NewOrderRepository(db)
	svc  := service.NewOrderService(repo, publisher, logger)
